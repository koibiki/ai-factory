...
from feature_engineering.rank_by_max import rank_feature
...
train_X = pd.concat([train_X_num], axis=1)
...
#     kmeans.fit(train_X)
#     meandistortions.append(sum(np.min(cdist(train_X, kmeans.cluster_centers_, 'euclidean'), axis=1))/train_X.shape[0])
#
